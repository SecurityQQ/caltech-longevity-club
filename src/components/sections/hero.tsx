...
const sponsorLogos = getEnabledSponsors();
...
const heroText = {
  ...
  trustedBy: "Supported by leaders in longevity science and biotechnology",
        ...
        <div className="container pt-4 px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <motion.div
              ...
              className="mt-10 md:mt-14 pt-6 md:pt-8 border-t border-border w-full"
            >
